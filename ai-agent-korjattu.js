...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const fallbackReply = text => {
    ...
    if (state.awaiting === 'websiteScope') {
      return 'En saanut vastauksesta vielä tarvittavaa tietoa. Kerro vain, onko kyse uusista verkkosivuista vai nykyisten uudistuksesta — sen jälkeen jatketaan yhdellä kysymyksellä kerrallaan.';
    }
    if (state.awaiting === 'automationScope') {
      return 'En saanut vielä kiinni automatisoitavasta työstä. Kerro yksi konkreettinen asia, jota teet usein käsin, esimerkiksi sähköpostien lajittelu, tarjouspyyntöjen käsittely tai tietojen kopiointi.';
    }
    return 'En saanut tuosta vielä kiinni 😄 Kokeile kysyä esimerkiksi “paljonko verkkosivut maksavat?”, “mitä AI-chatbot tekee?” tai “miten saan lisää näkyvyyttä Googleen?”.';
  };
